...
dependencies {
    ...
    implementation ("androidx.camera:camera-lifecycle:1.3.0") // Lifecycle integration
    implementation ("androidx.camera:camera-view:1.0.0-alpha09") // PreviewView
    ...
    implementation("org.tensorflow:tensorflow-lite:2.12.0") // or a version that matches your setup
